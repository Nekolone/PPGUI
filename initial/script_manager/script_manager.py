...
from PySide6.QtWidgets import QPushButton, QListWidgetItem, QListWidget, QToolButton

from initial.utility import *


class ScriptManager:
    def __init__(self, script_depend_status, window):
        self.window = window

        self.script_depend_status = script_depend_status
